...
function ToggleThemeButton({}: Props) {
  ...
  return (
    <button
      className="hidden items-center gap-5 text-gray-600 transition-all hover:scale-105 hover:font-medium hover:text-gray-900 sm:flex dark:text-gray-300 dark:hover:text-white"
